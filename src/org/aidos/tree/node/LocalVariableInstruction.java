 ...
 * @author `Discardedx2
 */
public class LocalVariableInstruction extends InstructionNode {
	 ...
	 */
	public LocalVariableInstruction(MethodDecNode owner, String name, String desc, String signature, Label start, Label end, int index, int position, int opcode) {
